function [data_fun, ndata] = hdr_data_hdrps( opt, data_idx )
...
imgfiles = dir(fullfile('/visinf/projects/visinf/datasets/HDR/HDRPS/','*.mat'));
...
ndata = numel(imgfiles);
    ...
    function [Iclean] = fun(i)
        d = load(fullfile(imgfiles(i).folder, imgfiles(i).name));
        Iclean = d.I;
