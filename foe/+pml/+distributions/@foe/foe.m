%% FOE - Abstract base class for modeling Fields of Experts
% Any derived class needs to supply the following (constant) property:
%
% * DEFAULT_EXPERT: Expert to be used if none supplied.
%
% All experts must be instances of the same class as DEFAULT_EXPERT,
% that is assumed to be a descendant of 'pml.distributions.density'.
%
% Data convention:
% Multiple images are stored in "column form" in a matrix of 
% size d x n, where d is the number of pixels of each image,
% and n is the number of distinct images.
% 
...
% $Id: foe.m 240 2011-05-30 16:24:20Z uschmidt $
